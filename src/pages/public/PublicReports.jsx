  ...
  useEffect(() => {
    const loadReports = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(
            data.error || "Unable to load public reports."
          );
        }
        ...
        console.error(err);
        setError(
          err.message || "Unable to load public reports."
        );
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div className="public-reports-page">
      <div className="public-reports-header">
        ...
        <p>
          View issues currently being investigated or
          already resolved.
        </p>
      </div>
